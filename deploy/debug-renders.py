...
c.connect("80.78.248.96", username="root", key_filename=str(KEY), timeout=20)
cmds = [
    "curl -sI http://127.0.0.1:3000/renders/c1919968-3ff1-4fa8-a593-4b0bbf1902ed_screen_1.png | head -15",
    "curl -sI https://80-78-248-96.sslip.io/renders/c1919968-3ff1-4fa8-a593-4b0bbf1902ed_screen_1.png | head -15",
