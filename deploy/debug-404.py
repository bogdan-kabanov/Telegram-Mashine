...
cmds = [
    ...
    "curl -s -o /dev/null -w 'hosthdr:%{http_code}\\n' -H 'Host: 80-78-248-96.sslip.io' http://127.0.0.1:3000/renders/c1919968-3ff1-4fa8-a593-4b0bbf1902ed_screen_1.png",
    "curl -sI https://80-78-248-96.sslip.io/renders/c1919968-3ff1-4fa8-a593-4b0bbf1902ed_screen_1.png | head -20",
